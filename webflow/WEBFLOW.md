...
Home → **Webflow** (separate app at `webflow/` — `npm run webflow:dev`) → requirement likho → **Webflow par site banao**
...
→ `coupon-sites/sunlu-kanny-promo.html` — hosted full page (free plan). Embed: `coupon-sites/webflow-home-embed.html`

Frontend demo: `/webflow/demo` (KANNY 10% off full page).
